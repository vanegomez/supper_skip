...
category2 = restaurant1.categories.create(name: "Savory")
category3 = restaurant1.categories.create(name: "So Good and So Unhealthy")
category4 = restaurant1.categories.create(name: "I Can't Believe It's Good For Me")
category5 = restaurant1.categories.create(name: "You Put That In A Pie?")

category6 = restaurant2.categories.create(name: "Originals")
category7 = restaurant2.categories.create(name: "Salty")
category8 = restaurant2.categories.create(name: "Fatty")
category9 = restaurant2.categories.create(name: "Sugary")
category10 = restaurant2.categories.create(name: "Dreamy")
...
Order.create(user_id: 1, order_total: 15, order_type: "pick-up", delivery_address: nil, order_status: "completed", restaurant_id: 31)
Order.create(user_id: 1, order_total: 16, order_type: "delivery", delivery_address: "1520 Blake Street, Denver, CO", order_status: "cancelled", restaurant_id: 32)
Order.create(user_id: 2, order_total: 17, order_type: "pick-up", delivery_address: nil, order_status: "ordered", restaurant_id: 32)
Order.create(user_id: 3, order_total: 35, order_type: "pick-up", delivery_address: nil, order_status: "ordered", restaurant_id: 32)
Order.create(user_id: 4, order_total: 45, order_type: "pick-up", delivery_address: nil, order_status: "cancelled", restaurant_id: 32)
Order.create(user_id: 4, order_total: 34, order_type: "delivery", delivery_address: "1510 Blake Street, Denver, CO", order_status: "completed", restaurant_id: 32)
Order.create(user_id: 3, order_total: 78, order_type: "pick-up", delivery_address: nil, order_status: "completed", restaurant_id: 32)
Order.create(user_id: 2, order_total: 88, order_type: "pick-up", delivery_address: nil, order_status: "completed", restaurant_id: 32)
Order.create(user_id: 4, order_total: 34, order_type: "pick-up", delivery_address: nil, order_status: "completed", restaurant_id: 32)
Order.create(user_id: 3, order_total: 12, order_type: "pick-up", delivery_address: nil, order_status: "completed", restaurant_id: 32)

OrderItem.create(order_id: 1, item_id: 766)
OrderItem.create(order_id: 2, item_id: 767)
OrderItem.create(order_id: 3, item_id: 768)
OrderItem.create(order_id: 4, item_id: 769)
OrderItem.create(order_id: 5, item_id: 770)
OrderItem.create(order_id: 6, item_id: 771)
OrderItem.create(order_id: 7, item_id: 772)
OrderItem.create(order_id: 8, item_id: 773)
OrderItem.create(order_id: 9, item_id: 774)
OrderItem.create(order_id: 10, item_id: 775)
